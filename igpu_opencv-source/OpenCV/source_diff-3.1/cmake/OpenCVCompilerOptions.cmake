...
if(MSVC)
  ...
  if(NOT MSVC_VERSION LESS 1400 AND NOT INTEL_OFFLOAD)
    set(OPENCV_EXTRA_FLAGS "${OPENCV_EXTRA_FLAGS} /bigobj")
  endif()
  if(INTEL_OFFLOAD)
    set(OPENCV_EXTRA_FLAGS "${OPENCV_EXTRA_FLAGS} /Qrestrict")
    set(OPENCV_EXTRA_FLAGS "${OPENCV_EXTRA_FLAGS} /Qstd=c++11")
  endif()
  if(BUILD_WITH_DEBUG_INFO)
